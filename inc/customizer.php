    ...
    function ifrs_get_unidades() {
        return array(
            'reitoria' => array(
                ...
                'image'  => get_stylesheet_directory_uri().'/img/marcas/ifrs.png',
            ),
            'alvorada' => array(
                'option' => 'Alvorada',
                'title'  => 'Campus Alvorada',
                'url'    => 'https://ifrs.edu.br/alvorada',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/alvorada.png',
            ),
            'bento' => array(
                'option' => 'Bento Gonçalves',
                'title'  => 'Campus Bento Gonçalves',
                'url'    => 'https://ifrs.edu.br/bento',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/bento.png',
            ),
            'canoas' => array(
                'option' => 'Canoas',
                'title'  => 'Campus Canoas',
                'url'    => 'https://ifrs.edu.br/canoas',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/canoas.png',
            ),
            'caxias' => array(
                'option' => 'Caxias do Sul',
                'title'  => 'Campus Caxias do Sul',
                'url'    => 'https://ifrs.edu.br/caxias',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/caxias.png',
            ),
            'erechim' => array(
                'option' => 'Erechim',
                'title'  => 'Campus Erechim',
                'url'    => 'https://ifrs.edu.br/erechim',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/erechim.png',
            ),
            'farroupilha' => array(
                'option' => 'Farroupilha',
                'title'  => 'Campus Farroupilha',
                'url'    => 'https://ifrs.edu.br/farroupilha',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/farroupilha.png',
            ),
            'feliz' => array(
                'option' => 'Feliz',
                'title'  => 'Campus Feliz',
                'url'    => 'https://ifrs.edu.br/feliz',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/feliz.png',
            ),
            'ibiruba' => array(
                'option' => 'Ibirubá',
                'title'  => 'Campus Ibirubá',
                'url'    => 'https://ifrs.edu.br/ibiruba',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/ibiruba.png',
            ),
            'osorio' => array(
                'option' => 'Osório',
                'title'  => 'Campus Osório',
                'url'    => 'https://ifrs.edu.br/osorio',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/osorio.png',
            ),
            'poa' => array(
                'option' => 'Porto Alegre',
                'title'  => 'Campus Porto Alegre',
                'url'    => 'https://poa.ifrs.edu.br/',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/poa.png',
            ),
            'restinga' => array(
                'option' => 'Restinga',
                'title'  => 'Campus Restinga',
                'url'    => 'https://ifrs.edu.br/restinga',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/restinga.png',
            ),
            'riogrande' => array(
                'option' => 'Rio Grande',
                'title'  => 'Campus Rio Grande',
                'url'    => 'https://ifrs.edu.br/riogrande',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/riogrande.png',
            ),
            'rolante' => array(
                'option' => 'Rolante',
                'title'  => 'Campus Rolante',
                'url'    => 'https://ifrs.edu.br/rolante',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/rolante.png',
            ),
            'sertao' => array(
                'option' => 'Sertão',
                'title'  => 'Campus Sertão',
                'url'    => 'https://ifrs.edu.br/sertao',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/sertao.png',
            ),
            'vacaria' => array(
                'option' => 'Vacaria',
                'title'  => 'Campus Vacaria',
                'url'    => 'https://ifrs.edu.br/vacaria',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/vacaria.png',
            ),
            'veranopolis' => array(
                'option' => 'Veranópolis',
                'title'  => 'Campus Veranópolis',
                'url'    => 'https://ifrs.edu.br/veranopolis',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/veranopolis.png',
            ),
            'viamao' => array(
                'option' => 'Viamão',
                'title'  => 'Campus Viamão',
                'url'    => 'https://ifrs.edu.br/viamao',
                'image'  => get_stylesheet_directory_uri().'/img/marcas/viamao.png',
            ),
        );
    }
